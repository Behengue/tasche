  ...
  ?>
	...
	<div class="container">
		<div class="row" style="margin-top:80px;">
		 ...
		 <form class="form-group" action="../controller/kategorieRegController.php" method="POST" enctype="multipart/form-data" class="form col-lg-push-3 col-lg-6">
				...
				<div class="form-group">
					<label for="bezeichnung">Kategorienbezeichnung (max. 255 Zeichen):</label>
